...
func Test_transferUseCase_creditDestinationAccount(t *testing.T) {
	type fields struct {
		trfRepo repository.TransferRepository
		accRepo repository.AccountRepository
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := trfUC.creditDestinationAccount(tt.args.ctx, tt.args.transfer); (err != nil) != tt.wantErr {
				t.Errorf("creditDestinationAccount() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}

func Test_transferUseCase_debitOriginAccount(t *testing.T) {
	type fields struct {
		trfRepo repository.TransferRepository
		accRepo repository.AccountRepository
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := trfUC.debitOriginAccount(tt.args.ctx, tt.args.transfer); (err != nil) != tt.wantErr {
				t.Errorf("debitOriginAccount() error = %v, wantErr %v", err, tt.wantErr)
			}
		})
	}
}
