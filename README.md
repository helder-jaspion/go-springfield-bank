...
You can quickly build and run the application with its dependencies with this command (
...
using the `MONITORING_PORT` [environment variable](#environment-variables).
